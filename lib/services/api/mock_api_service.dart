...
class MockApiService {
  static final List<User> _members = [
    User(id: '1', name: 'Salman', email: 'admin@gmail.com', password: '11', role: UserRole.admin),
    User(id: '2', name: 'Md. Istiaqe Ahmed', email: 'istiaqe@fireai.agency', password: 'password123', role: UserRole.sales),
    User(id: '3', name: 'Md. Shahin Alam Alif', email: 'shahin@fireai.com', password: 'password123', role: UserRole.sales),
    User(id: '4', name: 'Saidul Islam Apu', email: 'opu@gmail.com', password: '11', role: UserRole.sales),
    User(id: '5', name: 'Nirmol Malo', email: 'nirmol@fireai.com', password: 'password123', role: UserRole.sales),
    User(id: '6', name: 'Sumaia Akther Urmi', email: 'urmi@fireai.com', password: 'password123', role: UserRole.sales),
    User(id: '7', name: 'Piqlu Chowdhury', email: 'piqlu@fireai.com', password: 'password123', role: UserRole.sales),
    User(id: '8', name: 'Minhaz Chowdhury', email: 'minhaz@fireai.com', password: 'password123', role: UserRole.sales),
    User(id: '9', name: 'AKASH', email: 'akash@fireai.com', password: 'password123', role: UserRole.sales),
    User(id: '10', name: 'Kritab Mondal Tanu', email: 'tanu@fireai.com', password: 'password123', role: UserRole.sales),
  ];
  ...
  Future<DashboardStats> getStats() async {
    double totalSales = _queries.fold(0, (sum, q) => sum + q.amount);
    await Future.delayed(const Duration(milliseconds: 500));
